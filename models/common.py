...
class C3(nn.Module):
    ...
    def __init__(self, c1, c2, c2o, n=1, shortcut=True, g=1, e=[0.5,0.5], rate=[1.0 for _ in range(12)]):  # ch_in1, ch_in2, ch_out, number of Bottleneck, shortcut, groups, cv1 cv2 expansion, every Bottleneck expansion
        super().__init__()
        # c_ = int(c2 * e)  # hidden channels
